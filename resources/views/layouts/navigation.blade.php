            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                        style="font-size: 25px;  font-family:'Briem Hand, cursive'; text-decoration:none">
                        {{ __('The Souled Shop') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            @if (Auth::user()->image)
                                {{-- <img class="h-8 w-8 rounded-full" src="{{ asset('storage/' . Auth::user()->image) }}"
                                    alt="Profile Image"> --}}
                                <img src="{{ asset('storage/' . Auth::user()->image) }}?v={{ time() }}"
                                    alt="Profile Image" class="w-9 h-9 rounded-full ">
                            @else
                                <svg class="h-8 w-8 fill-current text-gray-500 rounded-full"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M10 1C5.589 1 2 4.589 2 9s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm0 2a6 6 0 110 12 6 6 0 010-12zm0 3a2 2 0 110 4 2 2 0 010-4zm0 5c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3z"
                                        clip-rule="evenodd" />
                                </svg>
                            @endif
